...
class PublicController extends Controller
{
    ...
    {
        $rate = explode(',', PublicController::getSysInfo(7));    // 1级 钻石会员
        $rate2 = explode(',', PublicController::getSysInfo(12));  // 2级 金牌会员
        $rate3 = explode(',', PublicController::getSysInfo(13));  // 3级  普通会员
        if ($grade != 0) {
