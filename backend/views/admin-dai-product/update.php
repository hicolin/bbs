                    ...
                    <div class="tab-content">
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="" class="fy" name="AdminDaiProduct[fy_one]" value="<?=$model->fy_two?>" style="width: 200px;margin-left: 12px;" id="fy_oneq">
                            ...
                            <div class="form-group">
                                ...
                                <span id="fy_one">(元)</span>
                                <input type="hidden" name="" id="fy_types" value="<?=$model->fy_type?>">
                                <input type="" class="fy" name="AdminDaiProduct[fy_two]" value="<?=$model->fy_three?>" style="width: 200px;margin-left: 12px;" id="fy_twoq">
                                <input type="button" name="" ><span style="color: red;">1、2、3级请用英文逗号隔开</span>
                            </div>
                            <div class="form-group">
                                购买产品普通会员返佣
                                <span id="fy_one">(元)</span>
                                <input type="hidden" name="" id="fy_types" value="<?=$model->fy_type?>">
                                <input type="" class="fy" name="AdminDaiProduct[fy_three]" value="<?=$model->fy_one?>" style="width: 200px;margin-left: 12px;" id="fy_threeq">
                                <input type="button" name="" ><span style="color: red;">1、2、3级请用英文逗号隔开</span>
                            </div>
                        </div>
                        </div>
