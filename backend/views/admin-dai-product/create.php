                ...
                <div class="box-body">
                    ...
                    <div class="tab-content">
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-group">
                                购买产品金牌会员返佣
                                <span id="fy_two">(元)</span>
                                <input type="" class="fy" name="AdminDaiProduct[fy_two]" value="" style="width: 200px;margin-left: 12px;" id="fy_twoq">
                                <input type="button" name="" ><span style="color: red;">1、2、3级请用英文逗号隔开</span>
                            </div>
                            <div class="form-group">
                                购买产品金牌会员返佣
                                <span id="fy_three">(元)</span>
                                <input type="" class="fy" name="AdminDaiProduct[fy_three]" value="" style="width: 200px;margin-left: 12px;" id="fy_threeq">
                                <input type="button" name="" ><span style="color: red;">1、2、3级请用英文逗号隔开</span>
                            </div>
                        </div>
                        </div>
