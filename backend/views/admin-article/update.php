                ...
                <div class="box-body">
                    ...
                    <div class="tab-content">
                        ...
                        <!--<div class="form-group">
                            <div class="form-group">
                                <label for="name"
                                       class="col-sm-2 control-label"><?php /*echo $modelLabel->getAttributeLabel("permission") */?>
                                    <span style="font-size: 12px;color: red;">(*注：勾选为可见) </span></label>
                                <div class="col-sm-8">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <select name="grade" id="grade">
                                    <?php foreach ($gradeArr as $k => $v): ?>
                                    <option value="<?= $k ?>" <?= $model['grade'] == $k ? 'selected' : '' ?>><?= $v ?></option>
                                    <?php endforeach; ?>
                                </select>
                            </div>
                        </div>
