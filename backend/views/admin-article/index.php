                    ...
                    <div id="example1_wrapper" class="dataTables_wrapper form-inline dt-bootstrap">
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <div class="form-group" style="margin-left: 15px;width: 250px;">
                                    <label>会员权限:</label>
                                    <select name="query[grade]" id="query[grade]"style="height:30px; width: 125px;border: 1px solid #ccc;">
                                        <option value="">全部</option>
                                        <?php foreach ($gradeArr as $k => $v): ?>
                                        <option value="<?= $k ?>" <?= $query['grade'] == $k ? 'selected': '' ?>><?= $v ?></option>
                                        <?php endforeach; ?>
                                    </select>
                                </div>
                                <div class="form-group" style="margin-left: 15px;width: 250px;">
