                    ...
                    <div id="example1_wrapper" class="dataTables_wrapper form-inline dt-bootstrap">
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <div class="form-group" style="margin: 5px;">
                                    <input type="text" class="form-control" id="search[content]" name="search[content]" placeholder="内容" value="<?= isset($search["content"]) ? $search["content"] : "" ?>">
                                </div>
                                <div class="form-group" style="margin: 5px">
                            ...
                            <div class="col-sm-12">
                                ...
                                <table id="data_table" class="table table-bordered table-striped dataTable" role="grid"
                                    ...
                                    <tr role="row">
                                        ...
                                        <th tabindex="0" aria-controls="data_table" rowspan="1" colspan="1"
                                            aria-sort="ascending">发信人昵称</th>
                                        <th tabindex="0" aria-controls="data_table" rowspan="1" colspan="1"
                                            aria-sort="ascending">发信人手机号</th>
                                        <th tabindex="0" aria-controls="data_table" rowspan="1" colspan="1"
                                            aria-sort="ascending">内容</th>
                                        <th tabindex="0" aria-controls="data_table" rowspan="1" colspan="1"
                                            aria-sort="ascending">收信人昵称</th>
                                        <th tabindex="0" aria-controls="data_table" rowspan="1" colspan="1"
                                            aria-sort="ascending">收信人手机号</th>
                                        <th tabindex="0" aria-controls="data_table" rowspan="1" colspan="1"
