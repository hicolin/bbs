                            ...
                            <div class="col-sm-12">
                                ...
                                <div class="form-group" style="margin: 5px;">
                                    ...
                                    <select name="query[grade]" class="form-control">
                                        ...
                                        <option value="2"> <?= Service::getMemberType(2) ?> </option>
                                        <option value="3"> <?= Service::getMemberType(3) ?> </option>
                                    </select>
                                </div>
                                <div class="form-group" style="margin: 5px;">
                                    <label> 合伙人:</label>
...
<!--                                <button id="delete_btn" type="button" class="btn btn-xs btn-danger">批量删除</button>&nbsp;&nbsp;-->
                                ...
                                <table id="data_table" class="table table-bordered table-striped dataTable" role="grid"
                                    ...
                                    <tr role="row">
                                        ...
                                        <!--<th tabindex="0" aria-controls="data_table" rowspan="1" colspan="1"-->
                                        <!--aria-sort="ascending">--><?//= $modelLabel->getAttributeLabel("end_time") ?><!--</th>-->
                                        <th tabindex="0" aria-controls="data_table" rowspan="1" colspan="1"
                                    ...
                                    foreach ($model as $list) {
                                        ...
                                        <tr id="rowid_$list->id">
                                            ...
                                            <td><?= Service::getMemberType($list['grade'], $list['end_time'], $list['id']) ?></td>
                                            <!--<td>--><?//= date('Y-m-d H:i:s', $list['end_time']) ?><!--</td>-->
                                            <td><?= $list['tel'] ?></td>
