...
class AppAsset extends AssetBundle
{
    ...
    public $css = [
        ...
        'mobile/web/js/layui/css/layui.css',
        'mobile/web/css/global.css',
        'mobile/web/plugins/mescroll/mescroll.css',
    ];
    public $js = [
        //'mobile/web/js/mobile/layerm.js',
        'mobile/web/js/jquery-1.8.3.min.js',
        'mobile/web/js/layer.js',
        'mobile/web/plugins/swiper/js/swiper.min.js',
        'mobile/web/js/layui/layui.js',
        'mobile/web/plugins/mescroll/mescroll.js',
    ];
    public $depends = [
       /* 'yii\web\YiiAsset',
